...
public class MainAdapter extends MenuAdapter implements Callback, PlatformActionListener {
    ...
    public View getGroupView(int position, ViewGroup menu) {
        ...
        tvTitle.setLayoutParams(new ScrollView.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        return tvTitle;
    }
    ...
    public View getItemView(SlidingMenuItem item, ViewGroup menu) {
        ...
        tvItem.setTextColor(tvItem.getResources().getColorStateList(R.color.normal_gray_pressed_white));
        ...
        tvItem.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, dp_52));
        return tvItem;
    }
