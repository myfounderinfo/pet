...
public class EditPage extends FakeActivity implements OnClickListener, TextWatcher, Callback {
    ...
    public void onCreate() {
        ...
        new Thread(){
                public void run() {
                        platformList = ShareSDK.getPlatformList(getContext());
    ...
    private void initPageView() {
        ...
        LinearLayout.LayoutParams lpInput = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.WRAP_CONTENT);
        ...
        LinearLayout.LayoutParams lpEt = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT);
        lpEt.weight = 1;
        ...
        FrameLayout.LayoutParams lpCounter = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT);
    ...
    private void initImage(LinearLayout llInput) {
        ...
        llRight.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT));
    ...
    private void checkAtMth(LinearLayout llInput, String platform) {
        if ("SinaWeibo".equals(platform) || "TencentWeibo".equals(platform) || "Facebook".equals(platform)
            ...
            FrameLayout.LayoutParams lpAt = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
                    LayoutParams.WRAP_CONTENT);
